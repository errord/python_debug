...
static int init_types(void)
{
        ...
        Int3_type = make_type("Int3", stmt_type, NULL, 0);
        if (!Int3_type) return 0;
...
stmt_ty
Int3(int lineno, int col_offset, PyArena *arena)
{
        stmt_ty p;
        p = (stmt_ty)PyArena_Malloc(arena, sizeof(*p));
        if (!p)
...
ast2obj_stmt(void* _o)
{
        ...
        case Continue_kind:
                ...
                break;
        case Int3_kind:
                result = PyType_GenericNew(Int3_type, NULL, NULL);
                if (!result) goto failed;
                break;
        }
...
obj2ast_stmt(PyObject* obj, stmt_ty* out, PyArena* arena)
{
        ...
        if (PyObject_IsInstance(obj, (PyObject*)Int3_type)) {

                *out = Int3(lineno, col_offset, arena);
                if (*out == NULL) goto failed;
                return 0;
        }
...
init_ast(void)
{
        ...
        if (PyDict_SetItemString(d, "Continue", (PyObject*)Continue_type) < 0)
            return;
        if (PyDict_SetItemString(d, "Int3", (PyObject*)Int3_type) < 0) return;
        if (PyDict_SetItemString(d, "expr", (PyObject*)expr_type) < 0) return;
